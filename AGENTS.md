...
## Recent Changes
- UC-20-payment-confirmation-ticket: Added Java (backend), HTML/CSS/JavaScript (frontend, vanilla) + None (no frameworks)
- UC-19-pay-registration-fee: Added Java (backend), HTML/CSS/JavaScript (frontend, vanilla) + None (no frameworks)
- UC-18-view-registration-prices: Added Java (backend), HTML/CSS/JavaScript (frontend, vanilla) + None (no frameworks)
