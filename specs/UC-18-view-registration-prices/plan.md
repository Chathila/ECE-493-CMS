...
**Branch**: `UC-18-view-registration-prices` | **Date**: 2026-02-06 | **Spec**: /Users/chathilaratnatilake/Documents/University/WINTER 2026/ECE 493/ECE-493-CMS/specs/UC-18-view-registration-prices/spec.md
**Input**: Feature specification from `/specs/UC-18-view-registration-prices/spec.md`

## Summary

Display registration prices to guests and registered users, show a pricing
unavailable message when pricing is not available, and show a retry-later
message when retrieval fails.
...
**Project Type**: web  
**Performance Goals**: Price retrieval and display complete within 5 minutes of
request  
...
```text
specs/UC-18-view-registration-prices/
